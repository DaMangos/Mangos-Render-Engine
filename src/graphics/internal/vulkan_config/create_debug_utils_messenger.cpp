...
vk::DebugUtilsMessengerCreateInfoEXT graphics::internal::vulkan_config::create_debug_utils_messenger_create_info()
{
...
vk::UniqueDebugUtilsMessengerEXT graphics::internal::vulkan_config::create_debug_utils_messenger(vk::Instance const instance)
{
