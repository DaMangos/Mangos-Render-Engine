...
{
  using namespace graphics::internal::vulkan_config;
...
vk::UniqueDevice graphics::internal::vulkan_config::create_device(vk::PhysicalDevice const physical_device, vk::SurfaceKHR const surface)
{
