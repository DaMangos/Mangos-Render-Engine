...
std::optional<std::uint32_t> graphics::detail::vulkan_config::find_queue_family_index(std::vector<vk::QueueFamilyProperties> const & queue_properties,
...
std::optional<std::uint32_t> graphics::detail::vulkan_config::find_surface_support_queue_family_index(vk::PhysicalDevice const physical_device,
