...
#include <glfw_wrapper/composites/coordinates.hpp>
#include <glfw_wrapper/composites/extent.hpp>
#include <glfw_wrapper/composites/image.hpp>
#include <glfw_wrapper/composites/offset.hpp>
#include <glfw_wrapper/composites/scale.hpp>
#include <glfw_wrapper/handles/library.hpp>
#include <glfw_wrapper/input/action.hpp>
#include <glfw_wrapper/input/keyboard.hpp>
#include <glfw_wrapper/input/modifiers.hpp>
#include <glfw_wrapper/input/mouse.hpp>
#include <glfw_wrapper/units/pixel.hpp>
